...
export default function Projects() {
    ...
    return (
        <main className="px-28 py-25 dark:bg-[#252128]" data-theme={darkMode ? "dark" : "light"}>
                ...
                <div className="project-item flex justify-between">
                    {data[language].projectsSection.projects.map((project, index) => (
                        <div key={index} className="w-72">
                            ...
                            <div className="buttons  text-sm text-indigo-800 font-medium leading-[100%] flex gap-2 mb-4 dark:text-[#8F88FF]">
