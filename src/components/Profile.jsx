...
export default function Profile() {
    ...
    return (
        <section className="px-28 pt-25 dark:bg-[#252128]" data-theme={darkMode ? "dark" : "light"}>
            <h2 className="font-semibold text-5xl text-gray-800 dark:text-[#AEBCCF] sm:text-center lg:text-start">{data[language].profileSection.title}</h2>
            <section className="flex justify-between mt-4 lg:flex-row sm:flex-col">
                ...
                <section className="profile-righ lg:w-[55%] lg:pl-25">
                    ...
                    <div className="lg:w-[34rem] sm:w-fit">
                        <p className="text-gray-500 lg:text-lg sm:text-base font-normal leading-[150%] mb-10 dark:text-white">{data[language].profileSection.aboutMeText1}</p>
                        <p className="text-gray-500 lg:text-lg sm:text-base font-normal leading-[150%] dark:text-white">{data[language].profileSection.aboutMeText2}</p>
                    </div>
                </section>
            </section>
        </section>
