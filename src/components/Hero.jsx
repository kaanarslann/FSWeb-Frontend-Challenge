    ...
    return (
        <main className="flex lg:justify-between lg:flex-row sm:flex-col items-center px-28 pt-20 dark:bg-[#252128]" data-theme={darkMode ? "dark" : "light"}>
            ...
            <div className="flex items-center space-x-4">
                ...
                <h1 className="text-7xl font-bold mt-8 leading-none w-[37.25rem] text-gray-800 dark:text-[#AEBCCF] sm:text-center lg:text-start">{data[language].heroSection.title1}<br/>{data[language].heroSection.title2}</h1>
                <p className="text-gray-500 text-lg font-normal w-[34.5rem] mt-8 leading-7 dark:text-white sm:text-center lg:text-start">{data[language].heroSection.intro}</p>
