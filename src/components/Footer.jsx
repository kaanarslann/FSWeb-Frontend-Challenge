...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#F9F9F9] pt-20 pb-30 px-28 dark:bg-[#141414]" data-theme={darkMode ? "dark" : "light"}>
            <h2 className="text-[#1F2937] font-semibold text-[2.6rem] leading-[125%] w-[33rem] mb-10 dark:text-[#AEBCCF] md:text-center lg:text-start">{data[language].footerSection.title}</h2>
            <section className="footer-links flex lg:flex-row md:flex-col justify-between">
                <div className="email md:text-center lg:text-start">
                ...
                <div className="socials flex gap-4 lg:justify-between md:justify-center lg:pt-0 md:pt-4">
