...
export default function Header() {
    ...
    return (
        <header className="pt-6 px-28 dark:bg-[#252128]" data-theme={darkMode ? "dark" : "light"}>
            <section className='toggle-options flex lg:justify-end mr-7 md:justify-center'>
                ...
                <span className="text-[15px] font-medium text-[#777777] dark:text-gray-300 ml-4">{!darkMode ? data[language].headerSection.darkMode : data[language].headerSection.lightMode}</span>
                <span className="text-[15px] font-medium text-gray-900 dark:text-gray-300 ml-4">|</span>
                <span className="text-[15px] font-medium text-gray-900 dark:text-gray-300 ml-5"><span className="text-[#4731D3] cursor-pointer" onClick={toggleLanguage}>{data[language].headerSection.language1}</span> {data[language].headerSection.language2}</span>
            </section>
            <section className='flex lg:justify-between mt-4 md:justify-center'>
